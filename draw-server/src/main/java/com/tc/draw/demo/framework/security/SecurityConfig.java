...
import com.tc.draw.demo.framework.security.filter.JwtAuthenticationTokenFilter;
import com.tc.draw.demo.framework.security.handle.AuthenticationEntryPointImpl;
import com.tc.draw.demo.framework.security.handle.LogoutSuccessHandlerImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
				...
				.antMatchers("/login", "/sso/**","/captchaImage", "/captchaNeed","/websocket/**").anonymous()
