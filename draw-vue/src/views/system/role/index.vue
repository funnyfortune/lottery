    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类型" align="center" prop="name" >
        <template slot-scope="scope">
          <el-tag size="small" type="default" v-if="scope.row.isSys===1">内置</el-tag>
          <el-tag size="small" type="success" v-else>自定义</el-tag>
        </template>
      </el-table-column>
...
<!--          >数据权限</el-button>-->
          ...
          <div v-if="scope.row.isSys == 1 && userId == 1">
            <el-button
              size="mini"
              type="text"
              icon="el-icon-edit"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listRole(this.addDateTimeRange(this.queryParams, this.dateRange)).then(
        response => {
