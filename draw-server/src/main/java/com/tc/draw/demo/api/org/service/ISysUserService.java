...
public interface ISysUserService
{
     ...
     * @return 用户信息集合信息
     */
     List<SysUserListVO> selectUserList(SysUserListDTO user);
     ...
     * @return 结果
     */
     String checkPhoneUnique(Long userId, String number);
     ...
     * @return 结果
     */
     String importUser(List<SysUserImportBO> userList, Boolean isUpdateSupport);


    List<SysUserListVO> selectEngineerList(String userName, Long deptId);
